...
CONFIG_PATH="${CONFIG_PATH:-configs/train_dit_nskt_science.yaml}"
PRETRAINED_VAE_PATH="${PRETRAINED_VAE_PATH:-/pscratch/sd/p/puren93/puren/Interp-DM/EDEN/output/experiments-EDEN_VAE/014/checkpoints/0020000.pt}"
