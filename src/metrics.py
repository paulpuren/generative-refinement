"""
Evaluation metrics using numpy

The original code from DiffCast
Link: https://github.com/DeminYu98/DiffCast/blob/main/utils/metrics.py
"""
...
def cal_cprs2(pred, true):
    '''
    cal cprs(continuous ranked probability score) in numpy, 
